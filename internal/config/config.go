...
// func Load() Config {
// 	return Config{
// 		DBHOST: getEnv("DB_HOST", "crypto-postgres"),
...
type Config struct {
	...
	DBUser     string `envconfig:"POSTGRES_USER" default:"test-user"`
	DBPassword string `envconfig:"POSTGRES_PASSWORD" default:"test-password"`
	DBName     string `envconfig:"POSTGRES_DB" default:"test-db"`
}
